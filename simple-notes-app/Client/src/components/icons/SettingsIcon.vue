<template>
    <svg class="settings-svg-icon" :width="width" :height="height" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
        <g id="SVGRepo_iconCarrier">
            <g>
                <circle cx="12" cy="12" r="2"  stroke-width="1.152">
                </circle>
                <path  class="settings-svg-icon"
                    ...
                    stroke="#292929" stroke-width="1.152" stroke-linejoin="round"></path>
            </g>
        </g>
    </svg>
</template>
